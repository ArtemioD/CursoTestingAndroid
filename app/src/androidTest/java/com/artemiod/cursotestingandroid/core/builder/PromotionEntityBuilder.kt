...
class PromotionEntityBuilder {
    ...
    private var productIds: String = """["productId1", "productId2"]"""
    private var value: Double = 10.0
    private var bayQuantity: Int? = null
    ...
    fun withBayQuantity(bayQuantity: Int?) = apply { this.bayQuantity = bayQuantity }
    ...
    fun withBuyY(payY: Int?) = apply { this.payY = payY }
